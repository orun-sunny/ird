const Settings = () => {
  return (
    <div className="bg-white ">
      ...
      <div className="mb-3">
        ...
        <input
          ...
          className="w-full bg-transparent cursor-pointer appearance-none disabled:opacity-50 disabled:pointer-events-none focus:outline-none
            ...
            [&::-webkit-slider-runnable-track]:dark:bg-neutral-900
      ...
      <div className="flex justify-between mb-3 bg-slate-100">
        <h1>নাইট মোড</h1>
        <div>
          <input
            type="checkbox"
            id="hs-basic-usage"
            className="relative w-[3.25rem] h-7 p-px bg-gray-900 border-transparent text-transparent rounded-full cursor-pointer transition-colors  duration-200 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-800 dark:border-neutral-700 dark:focus:ring-offset-gray-600 before:inline-block before:size-6 before:bg-white  before:translate-x-0 checked:before:translate-x-full before:rounded-full before:shadow before:transform before:ring-0 before:transition before:ease-in-out before:duration-200 dark:before:bg-neutral-800"
          />
      ...
      <div className="bg-green-600 rounded-lg p-3 py-6">
